import{premi as d}from"./premiUI-DhbVcpuo.js";import"./index-Cba0P0US.js";const e=o=>document.getElementById(o),a=o=>o===1?"1 giorno":`${o} giorni`;function v(){p("costanza")}function p(o){const n=e(o);if(!n)return;const i=d();if(!i){n.hidden=!0;return}if(!i.giornate){n.hidden=!0;return}const s=i.prossimo,c=i.nome,r=i.strisciaMigliore>i.striscia,t=!!s&&s.mancano<=30;n.hidden=!1,n.innerHTML=`
    <div class="cz-riga">
      <div class="cz-ora">
        <b>${a(i.striscia)}</b>
        <span>di fila</span>
