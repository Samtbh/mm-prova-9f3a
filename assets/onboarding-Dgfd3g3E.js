...
import{E as f,i,F as m,G as x,_ as q,H as _}from"./index-CDkCT5Go.js";const b="mm2_onboarded";function I(r){if(r){const e=!!(r.age&&r.height_cm&&r.weight_kg);return e?localStorage.setItem(b,"1"):localStorage.removeItem(b),!e}return!localStorage.getItem(b)}const w=["gennaio","febbraio","marzo","aprile","maggio","giugno","luglio","agosto","settembre","ottobre","novembre","dicembre"],M=["domenica","lunedì","martedì","mercoledì","giovedì","venerdì","sabato"],$=r=>{const[e,o,u]=r.split("-").map(Number);return`${M[new Date(e,o-1,u).getDay()]} ${u} ${w[o-1]}`};function A(r){const e={sex:null,age:null,heightCm:null,weightKg:null,goal:null,delta:null,startDate:f()};let o=0;const u=5,c=document.createElement("div");c.className="onb",c.innerHTML=`<div class="obox">
