...
import{u as v,_ as c}from"./index-DPsIq1O0.js";const i=t=>document.getElementById(t),l=30;function g(){const t=i("letturaBox");if(!t)return;const n=Object.keys(v()).length,s=n>=l,a=Math.min(100,Math.round(n/l*100));if(!s){t.innerHTML=`<div class="attesa">
