const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CzF9L4Ks.js","./index-C0juWENH.css","./recuperiUI-B_8DY5RF.js","./swipe-BFJIPpwd.js"])))=>i.map(i=>d[i]);
import{j as h,q as f,_ as d,N as $,t as p,H as b,O as D,P as y}from"./index-CzF9L4Ks.js";const u=a=>document.getElementById(a),I=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"],T=["domenica","lunedì","martedì","mercoledì","giovedì","venerdì","sabato"],O=(a,t)=>{const[i,e,s]=a.split("-").map(Number),[l,r,o]=t.split("-").map(Number);return Math.round((Date.UTC(l,r-1,o)-Date.UTC(i,e-1,s))/864e5)};function _(a){const t=O(p,a);if(t===0)return"oggi";if(t===1)return"domani";const[i,e,s]=a.split("-").map(Number);return t<=6?T[new Date(Date.UTC(i,e-1,s)).getUTCDay()]:`${s} ${I[e-1]}`}let c=null,m=!1;function E(){const a=u("pianoBox");if(!a)return;if(!h().filter(n=>!n.doOn).length){a.innerHTML="",c=null;return}if(!c){a.innerHTML='<div class="pia pia-attesa">Sto guardando il tuo ciclo…</div>',q();return}const{mosse:i,fuori:e}=c;if(!i.length&&!e.length){a.innerHTML="";return}const s=i.map(n=>`
    <div class="pia-riga">
