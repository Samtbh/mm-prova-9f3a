const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-YS2ZJR-3.js","./index-DfQ7o_Qt.css","./pianoUI-Cd6inkZC.js","./notifiche-B9un_q-Q.js","./creditoUI-Cmi9MmfG.js"])))=>i.map(i=>d[i]);
import{o as O,_ as l,k as D,n as I,q as E,t as P,u as y}from"./index-YS2ZJR-3.js";import{scorriPerEliminare as S,suggerisciIlGesto as T}from"./swipe-BFJIPpwd.js";const m=t=>document.getElementById(t),$=t=>String(Math.round(t)).replace(/\B(?=(\d{3})+(?!\d))/g,"."),R=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"];function g(t){const[,i,d]=t.split("-").map(Number);return`${d} ${R[i-1]}`}async function V(t){const{allDays:i}=await l(async()=>{const{allDays:a}=await import("./index-YS2ZJR-3.js").then(o=>o.V);return{allDays:a}},__vite__mapDeps([0,1]),import.meta.url),{addDaysISO:d}=await l(async()=>{const{addDaysISO:a}=await import("./index-YS2ZJR-3.js").then(o=>o.T);return{addDaysISO:a}},__vite__mapDeps([0,1]),import.meta.url),n=i()[d(y,-1)];if(!n?.splitDone)return[];const{analisi:r}=await l(async()=>{const{analisi:a}=await import("./index-YS2ZJR-3.js").then(o=>o.R);return{analisi:a}},__vite__mapDeps([0,1]),import.meta.url);return((await r("guardia",{label:t,giornoPrima:n.splitDone,data:y}))?.avvisi??[]).map(a=>a.testo)}const v=()=>new Date().toISOString().slice(0,10);async function f(t,i,d){const n=d.querySelector(".rec-nota");if(n&&(n.textContent="",n.classList.remove("attenzione")),i===v()&&d.dataset.forzato!=="1"){n&&(n.textContent="Controllo…");const a=await V(t.label);if(a.length){d.dataset.forzato="1",n&&(n.innerHTML=`${a.join(" ")} <button class="mini">Oggi lo stesso</button>`,n.classList.add("attenzione"),n.querySelector("button").onclick=()=>{f(t,i,d)});return}}P(t.id,i),l(()=>import("./pianoUI-Cd6inkZC.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(a=>a.scordaIlPiano()),p();const{paintOggiAlert:r,aggiornaLampeggio:e}=await l(async()=>{const{paintOggiAlert:a,aggiornaLampeggio:o}=await import("./index-YS2ZJR-3.js").then(c=>c.Y);return{paintOggiAlert:a,aggiornaLampeggio:o}},__vite__mapDeps([0,1]),import.meta.url);r(),e(),l(()=>import("./notifiche-B9un_q-Q.js"),__vite__mapDeps([3,0,1]),import.meta.url).then(a=>a.paintNotifiche(null))}function q(t){const i=v(),d=t.dueBy<i,n=t.doOn?t.doOn===i?"oggi":g(t.doOn):null;return`<div class="g-row rec-row${d?" scaduto":""}${n?" scelto":""}" data-rec="${t.id}">
    <div class="t">
      <b>${t.label}</b>
    ...
    <div class="rec-az">
  ...
  </div>`}function p(t){l(()=>import("./creditoUI-Cmi9MmfG.js"),__vite__mapDeps([4,0,1]),import.meta.url).then(o=>o.paintCredito()),l(()=>import("./pianoUI-Cd6inkZC.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(o=>o.paintPiano());const i=I(),d=D(),n=m("debitoBox");if(n)if(i&&i.totale>0){n.innerHTML=`<div class="deb">
        <div class="deb-top">
          <div>
      ...
      </div>`;const o=async s=>{const u=Math.max(1,Math.min(14,Math.round(s))),h=m("debNota");h&&(h.textContent="Salvo…");const b=await l(()=>import("./index-YS2ZJR-3.js").then(_=>_.R),__vite__mapDeps([0,1]),import.meta.url),w=b.profilo();await b.salvaProfilo({prefs:{...w?.prefs??{},rientroGiorni:u}});const{recomputeNow:A}=await l(async()=>{const{recomputeNow:_}=await import("./index-YS2ZJR-3.js").then(L=>L.S);return{recomputeNow:_}},__vite__mapDeps([0,1]),import.meta.url);await A()};n.querySelectorAll("#debGiorni .splitchip").forEach(s=>{s.onclick=()=>{o(Number(s.dataset.g))}});const c=m("debKcal");if(c){const s=()=>{const u=Number(c.value);!u||u<1||o(Math.ceil(i.totale/u))};c.onchange=s,c.onkeydown=u=>{u.key==="Enter"&&s()}}}else n.innerHTML="";k(m("pendingBox"),d);const r=m("cicloDaDecidere");r&&(r.innerHTML="");const e=m("recVuoto");if(e){const o=!d.length&&!(i&&i.totale>0);e.innerHTML=o?`<div class="vuoto-ok">
          <b>Sei in pari.</b>
