const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-C2pO1Z_Y.js","./index-DA-b-FTT.css","./pianoUI-B-31DoDj.js","./notifiche-jOTv4NgV.js","./creditoUI-zLM8qJC3.js"])))=>i.map(i=>d[i]);
import{o as P,_ as s,j as D,k as I,n as y,q as T,t as $}from"./index-C2pO1Z_Y.js";import{scorriPerEliminare as R,suggerisciIlGesto as S}from"./swipe-BFJIPpwd.js";const m=t=>document.getElementById(t),w=t=>String(Math.round(t)).replace(/\B(?=(\d{3})+(?!\d))/g,"."),V=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"];function g(t){const[,i,d]=t.split("-").map(Number);return`${d} ${V[i-1]}`}async function q(t){const{allDays:i}=await s(async()=>{const{allDays:o}=await import("./index-C2pO1Z_Y.js").then(r=>r.T);return{allDays:o}},__vite__mapDeps([0,1]),import.meta.url),{addDaysISO:d}=await s(async()=>{const{addDaysISO:o}=await import("./index-C2pO1Z_Y.js").then(r=>r.R);return{addDaysISO:o}},__vite__mapDeps([0,1]),import.meta.url),e=i()[d($,-1)];if(!e?.splitDone)return[];const{analisi:n}=await s(async()=>{const{analisi:o}=await import("./index-C2pO1Z_Y.js").then(r=>r.P);return{analisi:o}},__vite__mapDeps([0,1]),import.meta.url);return((await n("guardia",{label:t,giornoPrima:e.splitDone,data:$}))?.avvisi??[]).map(o=>o.testo)}const _=()=>new Date().toISOString().slice(0,10);async function h(t,i,d){const e=d.querySelector(".rec-nota");if(e&&(e.textContent="",e.classList.remove("attenzione")),i===_()&&d.dataset.forzato!=="1"){e&&(e.textContent="Controllo…");const o=await q(t.label);if(o.length){d.dataset.forzato="1",e&&(e.innerHTML=`${o.join(" ")} <button class="mini">Oggi lo stesso</button>`,e.classList.add("attenzione"),e.querySelector("button").onclick=()=>{h(t,i,d)});return}}T(t.id,i),s(()=>import("./pianoUI-B-31DoDj.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(o=>o.scordaIlPiano()),v();const{paintOggiAlert:n,aggiornaLampeggio:a}=await s(async()=>{const{paintOggiAlert:o,aggiornaLampeggio:r}=await import("./index-C2pO1Z_Y.js").then(l=>l.W);return{paintOggiAlert:o,aggiornaLampeggio:r}},__vite__mapDeps([0,1]),import.meta.url);n(),a(),s(()=>import("./notifiche-jOTv4NgV.js"),__vite__mapDeps([3,0,1]),import.meta.url).then(o=>o.paintNotifiche(null))}function k(t){const i=_(),d=t.dueBy<i,e=t.doOn?t.doOn===i?"oggi":g(t.doOn):null;return`<div class="g-row rec-row${d?" scaduto":""}${e?" scelto":""}" data-rec="${t.id}">
    <div class="t">
      <b>${t.label}</b>
      ...
      <input class="rec-data" type="date" data-data="${t.id}"
  ...
  </div>`}function v(t){s(()=>import("./creditoUI-zLM8qJC3.js"),__vite__mapDeps([4,0,1]),import.meta.url).then(l=>l.paintCredito()),s(()=>import("./pianoUI-B-31DoDj.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(l=>l.paintPiano());const i=I(),d=D(),e=m("debitoBox");if(e)if(i&&i.totale>0){e.innerHTML=`<div class="deb">
        <div class="deb-top">
          <div>
        ...
        <div class="deb-scelta">
          ...
          <button class="vuoto-go" id="recVaiCiclo">Vedi il ciclo</button>
           ...
           recupero si chiude.</p>`;const e=(n,a)=>{const o=i.find(l=>l.id===n.dataset[a]),r=n.closest(".rec-row");return o&&r?{r:o,riga:r}:null};t.querySelectorAll("[data-oggi]").forEach(n=>{const a=e(n,"oggi");a&&(n.onclick=()=>{h(a.r,_(),a.riga)})}),t.querySelectorAll("[data-riparti]").forEach(n=>{const a=e(n,"riparti");a&&(n.onclick=async()=>{y(a.r.id),s(()=>import("./pianoUI-B-31DoDj.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(u=>u.scordaIlPiano());const{cycle:o}=await s(async()=>{const{cycle:u}=await import("./index-C2pO1Z_Y.js").then(c=>c.R);return{cycle:u}},__vite__mapDeps([0,1]),import.meta.url),{saveAll:r}=await s(async()=>{const{saveAll:u}=await import("./index-C2pO1Z_Y.js").then(c=>c.T);return{saveAll:u}},__vite__mapDeps([0,1]),import.meta.url);o.startDate=_(),r(),v();const{recomputeNow:l}=await s(async()=>{const{recomputeNow:u}=await import("./index-C2pO1Z_Y.js").then(c=>c.Q);return{recomputeNow:u}},__vite__mapDeps([0,1]),import.meta.url);l()})}),t.querySelectorAll("[data-quando],[data-cambia]").forEach(n=>{const a=e(n,n.dataset.quando?"quando":"cambia");if(!a)return;const o=a.riga.querySelector(".rec-data");o&&(n.onclick=()=>{o.hidden=!1;const r=o;try{r.showPicker?.()}catch{o.focus()}},o.onchange=()=>{o.value&&h(a.r,o.value,a.riga)})}),t.querySelectorAll(".rec-row").forEach(n=>{R(n,{etichetta:"Rinuncio",onVia:()=>{y(n.dataset.rec),s(()=>import("./pianoUI-B-31DoDj.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(a=>a.scordaIlPiano()),v(),s(()=>import("./index-C2pO1Z_Y.js").then(a=>a.W),__vite__mapDeps([0,1]),import.meta.url).then(a=>{a.aggiornaLampeggio(),a.paintOggiAlert()}),s(()=>import("./notifiche-jOTv4NgV.js"),__vite__mapDeps([3,0,1]),import.meta.url).then(a=>a.paintNotifiche(null))}})}),S(t)}function x(){P(()=>v()),v()}export{v as paintRecuperi,x as wireRecuperi};
