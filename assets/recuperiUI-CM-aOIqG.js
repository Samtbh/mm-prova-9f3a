const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-BETpLty-.js","./index-BfOMIe0x.css","./notifiche-B5BVfte5.js"])))=>i.map(i=>d[i]);
import{o as S,j as A,k as D,_ as d,n as q,q as $,t as k}from"./index-BETpLty-.js";import{scorriPerEliminare as P,suggerisciIlGesto as I}from"./swipe-BFJIPpwd.js";const u=t=>document.getElementById(t),y=t=>String(Math.round(t)).replace(/\B(?=(\d{3})+(?!\d))/g,"."),M=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"];function p(t){const[,i,r]=t.split("-").map(Number);return`${r} ${M[i-1]}`}async function T(t){const{allDays:i}=await d(async()=>{const{allDays:a}=await import("./index-BETpLty-.js").then(n=>n.N);return{allDays:a}},__vite__mapDeps([0,1]),import.meta.url),{addDaysISO:r}=await d(async()=>{const{addDaysISO:a}=await import("./index-BETpLty-.js").then(n=>n.L);return{addDaysISO:a}},__vite__mapDeps([0,1]),import.meta.url),o=i()[r($,-1)];if(!o?.splitDone)return[];const{analisi:c}=await d(async()=>{const{analisi:a}=await import("./index-BETpLty-.js").then(n=>n.J);return{analisi:a}},__vite__mapDeps([0,1]),import.meta.url);return((await c("guardia",{label:t,giornoPrima:o.splitDone,data:$}))?.avvisi??[]).map(a=>a.testo)}const b=()=>new Date().toISOString().slice(0,10);async function f(t,i,r){const o=r.querySelector(".rec-nota");if(o&&(o.textContent="",o.classList.remove("attenzione")),i===b()&&r.dataset.forzato!=="1"){o&&(o.textContent="Controllo…");const a=await T(t.label);if(a.length){r.dataset.forzato="1",o&&(o.innerHTML=`${a.join(" ")} <button class="mini">Oggi lo stesso</button>`,o.classList.add("attenzione"),o.querySelector("button").onclick=()=>{f(t,i,r)});return}}q(t.id,i),m();const{paintOggiAlert:c,aggiornaLampeggio:e}=await d(async()=>{const{paintOggiAlert:a,aggiornaLampeggio:n}=await import("./index-BETpLty-.js").then(l=>l.P);return{paintOggiAlert:a,aggiornaLampeggio:n}},__vite__mapDeps([0,1]),import.meta.url);c(),e(),d(()=>import("./notifiche-B5BVfte5.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(a=>a.paintNotifiche(null))}function R(t){const i=b(),r=t.dueBy<i,o=t.doOn?t.doOn===i?"oggi":p(t.doOn):null;return`<div class="g-row rec-row${r?" scaduto":""}${o?" scelto":""}" data-rec="${t.id}">
    <div class="t">
      <b>${t.label}</b>
    ...
    <div class="rec-az">
      ...
      </div>`;const n=async s=>{const g=Math.max(1,Math.min(14,Math.round(s))),_=u("debNota");_&&(_.textContent="Salvo…");const h=await d(()=>import("./index-BETpLty-.js").then(v=>v.J),__vite__mapDeps([0,1]),import.meta.url),E=h.profilo();await h.salvaProfilo({prefs:{...E?.prefs??{},rientroGiorni:g}});const{recomputeNow:L}=await d(async()=>{const{recomputeNow:v}=await import("./index-BETpLty-.js").then(O=>O.K);return{recomputeNow:v}},__vite__mapDeps([0,1]),import.meta.url);await L()};o.querySelectorAll("#debGiorni .splitchip").forEach(s=>{s.onclick=()=>{n(Number(s.dataset.g))}});const l=u("debKcal");if(l){const s=()=>{const g=Number(l.value);!g||g<1||n(Math.ceil(i.totale/g))};l.onchange=s,l.onkeydown=g=>{g.key==="Enter"&&s()}}}else o.innerHTML="";w(u("pendingBox"),r,"tutti"),w(u("cicloDaDecidere"),r.filter(n=>!n.doOn),"dadecidere");const c=u("recVuoto");if(c){const n=!r.length&&!(i&&i.totale>0);c.innerHTML=n?`<div class="vuoto-ok">
          <b>Sei in pari.</b>
