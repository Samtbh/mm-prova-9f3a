const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-DILr5A0X.js","./index-DwBjqQd2.css","./notifiche-C0yUvg52.js","./creditoUI-BYrx_1F9.js"])))=>i.map(i=>d[i]);
import{o as D,_ as u,j as S,k as P,n as E,q as I,t as $}from"./index-DILr5A0X.js";import{scorriPerEliminare as T,suggerisciIlGesto as q}from"./swipe-BFJIPpwd.js";const p=t=>document.getElementById(t),w=t=>String(Math.round(t)).replace(/\B(?=(\d{3})+(?!\d))/g,"."),M=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"];function v(t){const[,i,s]=t.split("-").map(Number);return`${s} ${M[i-1]}`}async function R(t){const{allDays:i}=await u(async()=>{const{allDays:a}=await import("./index-DILr5A0X.js").then(r=>r.P);return{allDays:a}},__vite__mapDeps([0,1]),import.meta.url),{addDaysISO:s}=await u(async()=>{const{addDaysISO:a}=await import("./index-DILr5A0X.js").then(r=>r.N);return{addDaysISO:a}},__vite__mapDeps([0,1]),import.meta.url),o=i()[s($,-1)];if(!o?.splitDone)return[];const{analisi:n}=await u(async()=>{const{analisi:a}=await import("./index-DILr5A0X.js").then(r=>r.L);return{analisi:a}},__vite__mapDeps([0,1]),import.meta.url);return((await n("guardia",{label:t,giornoPrima:o.splitDone,data:$}))?.avvisi??[]).map(a=>a.testo)}const _=()=>new Date().toISOString().slice(0,10);async function b(t,i,s){const o=s.querySelector(".rec-nota");if(o&&(o.textContent="",o.classList.remove("attenzione")),i===_()&&s.dataset.forzato!=="1"){o&&(o.textContent="Controllo…");const a=await R(t.label);if(a.length){s.dataset.forzato="1",o&&(o.innerHTML=`${a.join(" ")} <button class="mini">Oggi lo stesso</button>`,o.classList.add("attenzione"),o.querySelector("button").onclick=()=>{b(t,i,s)});return}}I(t.id,i),g();const{paintOggiAlert:n,aggiornaLampeggio:e}=await u(async()=>{const{paintOggiAlert:a,aggiornaLampeggio:r}=await import("./index-DILr5A0X.js").then(l=>l.S);return{paintOggiAlert:a,aggiornaLampeggio:r}},__vite__mapDeps([0,1]),import.meta.url);n(),e(),u(()=>import("./notifiche-C0yUvg52.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(a=>a.paintNotifiche(null))}function k(t){const i=_(),s=t.dueBy<i,o=t.doOn?t.doOn===i?"oggi":v(t.doOn):null;return`<div class="g-row rec-row${s?" scaduto":""}${o?" scelto":""}" data-rec="${t.id}">
    <div class="t">
      <b>${t.label}</b>
    ...
    <div class="rec-az">
  ...
  </div>`}function g(t){u(()=>import("./creditoUI-BYrx_1F9.js"),__vite__mapDeps([3,0,1]),import.meta.url).then(l=>l.paintCredito());const i=P(),s=S(),o=p("debitoBox");if(o)if(i&&i.totale>0){o.innerHTML=`<div class="deb">
        <div class="deb-top">
          <div>
      ...
      </div>`;const l=async c=>{const m=Math.max(1,Math.min(14,Math.round(c))),h=p("debNota");h&&(h.textContent="Salvo…");const y=await u(()=>import("./index-DILr5A0X.js").then(f=>f.L),__vite__mapDeps([0,1]),import.meta.url),A=y.profilo();await y.salvaProfilo({prefs:{...A?.prefs??{},rientroGiorni:m}});const{recomputeNow:L}=await u(async()=>{const{recomputeNow:f}=await import("./index-DILr5A0X.js").then(O=>O.M);return{recomputeNow:f}},__vite__mapDeps([0,1]),import.meta.url);await L()};o.querySelectorAll("#debGiorni .splitchip").forEach(c=>{c.onclick=()=>{l(Number(c.dataset.g))}});const d=p("debKcal");if(d){const c=()=>{const m=Number(d.value);!m||m<1||l(Math.ceil(i.totale/m))};d.onchange=c,d.onkeydown=m=>{m.key==="Enter"&&c()}}}else o.innerHTML="";V(p("pendingBox"),s);const n=p("cicloDaDecidere");n&&(n.innerHTML="");const e=p("recVuoto");if(e){const l=!s.length&&!(i&&i.totale>0);e.innerHTML=l?`<div class="vuoto-ok">
          <b>Sei in pari.</b>
