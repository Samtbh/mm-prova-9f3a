const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-ccrwIHem.js","./index-DOoneBgx.css","./notifiche-DOF-JeVh.js","./creditoUI-CFxbOM1W.js"])))=>i.map(i=>d[i]);
import{o as D,_ as u,j as S,k as I,n as E,q as T,t as $}from"./index-ccrwIHem.js";import{scorriPerEliminare as q,suggerisciIlGesto as M}from"./swipe-BFJIPpwd.js";const p=t=>document.getElementById(t),w=t=>String(Math.round(t)).replace(/\B(?=(\d{3})+(?!\d))/g,"."),P=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"];function v(t){const[,i,s]=t.split("-").map(Number);return`${s} ${P[i-1]}`}async function R(t){const{allDays:i}=await u(async()=>{const{allDays:a}=await import("./index-ccrwIHem.js").then(r=>r.O);return{allDays:a}},__vite__mapDeps([0,1]),import.meta.url),{addDaysISO:s}=await u(async()=>{const{addDaysISO:a}=await import("./index-ccrwIHem.js").then(r=>r.M);return{addDaysISO:a}},__vite__mapDeps([0,1]),import.meta.url),o=i()[s($,-1)];if(!o?.splitDone)return[];const{analisi:n}=await u(async()=>{const{analisi:a}=await import("./index-ccrwIHem.js").then(r=>r.K);return{analisi:a}},__vite__mapDeps([0,1]),import.meta.url);return((await n("guardia",{label:t,giornoPrima:o.splitDone,data:$}))?.avvisi??[]).map(a=>a.testo)}const _=()=>new Date().toISOString().slice(0,10);async function b(t,i,s){const o=s.querySelector(".rec-nota");if(o&&(o.textContent="",o.classList.remove("attenzione")),i===_()&&s.dataset.forzato!=="1"){o&&(o.textContent="Controllo…");const a=await R(t.label);if(a.length){s.dataset.forzato="1",o&&(o.innerHTML=`${a.join(" ")} <button class="mini">Oggi lo stesso</button>`,o.classList.add("attenzione"),o.querySelector("button").onclick=()=>{b(t,i,s)});return}}T(t.id,i),g();const{paintOggiAlert:n,aggiornaLampeggio:e}=await u(async()=>{const{paintOggiAlert:a,aggiornaLampeggio:r}=await import("./index-ccrwIHem.js").then(l=>l.Q);return{paintOggiAlert:a,aggiornaLampeggio:r}},__vite__mapDeps([0,1]),import.meta.url);n(),e(),u(()=>import("./notifiche-DOF-JeVh.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(a=>a.paintNotifiche(null))}function k(t){const i=_(),s=t.dueBy<i,o=t.doOn?t.doOn===i?"oggi":v(t.doOn):null;return`<div class="g-row rec-row${s?" scaduto":""}${o?" scelto":""}" data-rec="${t.id}">
    <div class="t">
      <b>${t.label}</b>
    ...
    <div class="rec-az">
  ...
  </div>`}function g(t){u(()=>import("./creditoUI-CFxbOM1W.js"),__vite__mapDeps([3,0,1]),import.meta.url).then(l=>l.paintCredito());const i=I(),s=S(),o=p("debitoBox");if(o)if(i&&i.totale>0){o.innerHTML=`<div class="deb">
        <div class="deb-top">
          <div>
      ...
      </div>`;const l=async c=>{const m=Math.max(1,Math.min(14,Math.round(c))),h=p("debNota");h&&(h.textContent="Salvo…");const y=await u(()=>import("./index-ccrwIHem.js").then(f=>f.K),__vite__mapDeps([0,1]),import.meta.url),A=y.profilo();await y.salvaProfilo({prefs:{...A?.prefs??{},rientroGiorni:m}});const{recomputeNow:L}=await u(async()=>{const{recomputeNow:f}=await import("./index-ccrwIHem.js").then(O=>O.L);return{recomputeNow:f}},__vite__mapDeps([0,1]),import.meta.url);await L()};o.querySelectorAll("#debGiorni .splitchip").forEach(c=>{c.onclick=()=>{l(Number(c.dataset.g))}});const d=p("debKcal");if(d){const c=()=>{const m=Number(d.value);!m||m<1||l(Math.ceil(i.totale/m))};d.onchange=c,d.onkeydown=m=>{m.key==="Enter"&&c()}}}else o.innerHTML="";V(p("pendingBox"),s);const n=p("cicloDaDecidere");n&&(n.innerHTML="");const e=p("recVuoto");if(e){const l=!s.length&&!(i&&i.totale>0);e.innerHTML=l?`<div class="vuoto-ok">
          <b>Sei in pari.</b>
