const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CyBvDjXu.js","./index-CQce-Rxu.css","./pianoUI-D5iZK5V-.js","./notifiche-Dy5RY1qM.js","./creditoUI-DIuursm_.js"])))=>i.map(i=>d[i]);
import{o as O,_ as l,k as D,n as I,q as E,t as P,u as y}from"./index-CyBvDjXu.js";import{scorriPerEliminare as S,suggerisciIlGesto as T}from"./swipe-BFJIPpwd.js";const m=t=>document.getElementById(t),$=t=>String(Math.round(t)).replace(/\B(?=(\d{3})+(?!\d))/g,"."),R=["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic"];function v(t){const[,i,d]=t.split("-").map(Number);return`${d} ${R[i-1]}`}async function V(t){const{allDays:i}=await l(async()=>{const{allDays:o}=await import("./index-CyBvDjXu.js").then(a=>a.V);return{allDays:o}},__vite__mapDeps([0,1]),import.meta.url),{addDaysISO:d}=await l(async()=>{const{addDaysISO:o}=await import("./index-CyBvDjXu.js").then(a=>a.T);return{addDaysISO:o}},__vite__mapDeps([0,1]),import.meta.url),n=i()[d(y,-1)];if(!n?.splitDone)return[];const{analisi:r}=await l(async()=>{const{analisi:o}=await import("./index-CyBvDjXu.js").then(a=>a.R);return{analisi:o}},__vite__mapDeps([0,1]),import.meta.url);return((await r("guardia",{label:t,giornoPrima:n.splitDone,data:y}))?.avvisi??[]).map(o=>o.testo)}const g=()=>new Date().toISOString().slice(0,10);async function f(t,i,d){const n=d.querySelector(".rec-nota");if(n&&(n.textContent="",n.classList.remove("attenzione")),i===g()&&d.dataset.forzato!=="1"){n&&(n.textContent="Controllo…");const o=await V(t.label);if(o.length){d.dataset.forzato="1",n&&(n.innerHTML=`${o.join(" ")} <button class="mini">Oggi lo stesso</button>`,n.classList.add("attenzione"),n.querySelector("button").onclick=()=>{f(t,i,d)});return}}P(t.id,i),l(()=>import("./pianoUI-D5iZK5V-.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(o=>o.scordaIlPiano()),p();const{paintOggiAlert:r,aggiornaLampeggio:e}=await l(async()=>{const{paintOggiAlert:o,aggiornaLampeggio:a}=await import("./index-CyBvDjXu.js").then(c=>c.Y);return{paintOggiAlert:o,aggiornaLampeggio:a}},__vite__mapDeps([0,1]),import.meta.url);r(),e(),l(()=>import("./notifiche-Dy5RY1qM.js"),__vite__mapDeps([3,0,1]),import.meta.url).then(o=>o.paintNotifiche(null))}function q(t){const i=g(),d=t.dueBy<i,n=t.doOn?t.doOn===i?"oggi":v(t.doOn):null;return`<div class="g-row rec-row${d?" scaduto":""}${n?" scelto":""}" data-rec="${t.id}">
    <div class="t">
      <b>${t.label}</b>
    ...
    <div class="rec-az">
  ...
  </div>`}function p(t){l(()=>import("./creditoUI-DIuursm_.js"),__vite__mapDeps([4,0,1]),import.meta.url).then(a=>a.paintCredito()),l(()=>import("./pianoUI-D5iZK5V-.js"),__vite__mapDeps([2,0,1]),import.meta.url).then(a=>a.paintPiano());const i=I(),d=D(),n=m("debitoBox");if(n)if(i&&i.totale>0){n.innerHTML=`<div class="deb">
        <div class="deb-top">
          <div>
      ...
      </div>`;const a=async s=>{const u=Math.max(1,Math.min(14,Math.round(s))),h=m("debNota");h&&(h.textContent="Salvo…");const b=await l(()=>import("./index-CyBvDjXu.js").then(_=>_.R),__vite__mapDeps([0,1]),import.meta.url),w=b.profilo();await b.salvaProfilo({prefs:{...w?.prefs??{},rientroGiorni:u}});const{recomputeNow:A}=await l(async()=>{const{recomputeNow:_}=await import("./index-CyBvDjXu.js").then(L=>L.S);return{recomputeNow:_}},__vite__mapDeps([0,1]),import.meta.url);await A()};n.querySelectorAll("#debGiorni .splitchip").forEach(s=>{s.onclick=()=>{a(Number(s.dataset.g))}});const c=m("debKcal");if(c){const s=()=>{const u=Number(c.value);!u||u<1||a(Math.ceil(i.totale/u))};c.onchange=s,c.onkeydown=u=>{u.key==="Enter"&&s()}}}else n.innerHTML="";k(m("pendingBox"),d);const r=m("cicloDaDecidere");r&&(r.innerHTML="");const e=m("recVuoto");if(e){const a=!d.length&&!(i&&i.totale>0);e.innerHTML=a?`<div class="vuoto-ok">
          <b>Sei in pari.</b>
